-- true-aim bundle: generated by scripts/build.ps1
-- repository: theneutral0ne/true-aim @ main
...
local function ResolveExecutionEnvironmentTable()
	if type(getfenv) == "function" then
		local SuccessBoolean, ResultValue = pcall(getfenv, 0)
		if SuccessBoolean and type(ResultValue) == "table" then
			return ResultValue
		end

		SuccessBoolean, ResultValue = pcall(getfenv)
		if SuccessBoolean and type(ResultValue) == "table" then
			return ResultValue
		end
	end
...
local SharedEnvironmentTable = ResolveExecutionEnvironmentTable()
if type(SharedEnvironmentTable) ~= "table" then
	error("true-aim: failed to resolve execution environment", 0)
end

SharedEnvironmentTable.__TRUE_AIM_EXPORT_ENV = SharedEnvironmentTable

local BundleSegmentsTable = {
	{
		path = "src/shared/00_bootstrap.lua",
		exports = {
			"RunService",
			"Players",
			"WorkspaceService",
		...
		source = [[local RunService = game.GetService(game, "RunService")
...
ObservedCharacterVelocitySampleByModelTable = setmetatable({}, { __mode = "k" })
	...
	{
		path = "src/games/00_registry.lua",
		exports = {
			"GameIntegrationProfilesByPlaceIdTable",
		},
		source = [[local GameIntegrationProfilesByPlaceIdTable = {
...
if CurrentGameIntegrationProfileTable
	...
	{
		path = "src/shared/05_runtime_state.lua",
		exports = {
			"PlayerListRuntimeTable",
			"ShieldModeRuntimeTable",
			"GetSearchableCharacterEntries",
			"RaycastBetweenIgnoringGlass",
			"IsCharacterForceFieldProtected",
			"GetPreferredTargetPart",
			"HasEquippedGun",
			"IsRaycastResultTargetHit",
			"RunUnredirectedWorkspaceRaycast",
		},
		source = [[LockKeyModesTable = { "RMB", "E", "Always" }
...
local RunUnredirectedWorkspaceRaycast
	...
	{
		path = "src/games/bloodzone/00_settings.lua",
		exports = {
			"SupportedBloodZoneWeaponTypesTable",
			"ExplosiveProjectileNameSetTable",
			"LauncherBallisticsProfileByNameTable",
			"IsSupportedBloodZoneWeaponType",
		},
		source = [[local SupportedBloodZoneWeaponTypesTable = {
	Gun = true,
	Launcher = true,
}
...
local function IsSupportedBloodZoneWeaponType(WeaponTypeString)
	...
	{
		path = "src/shared/10_core.lua",
		exports = {
			"SafeDebugName",
			"GetTargetIdentity",
			"UpdateDebugStatus",
			"IsMouseOverAimbotUi",
			"UiInteractionRuntimeTable",
			"SuppressAimbotUiInput",
			"IsAimbotUiInputSuppressed",
			"SendAimbotMouseClick",
			"DebugLog",
			"TraceLog",
			"FormatDebugVector3",
			"DescribeDebugInstance",
			"SafeGetLocalGunBase",
			"ResetRejectCounts",
			"RecordRejectReason",
			"GetRejectCountsSummary",
			"IsSillyModeEnabled",
			"IsSillyModeBehaviorActive",
			"IsEffectiveShieldModeEnabled",
			"GetProjectileProfileSpeedNumber",
			"ShouldUseForceCurveProjectileProfile",
			"GetProjectileProfileGravityNumber",
			"GetProjectileProfileGravityMagnitudeNumber",
			"GetProjectileSplashRadiusNumber",
			"IsExplosiveProjectileProfile",
			"ShouldUseProjectileArcVisibilityProfile",
			"ShouldPreferHighArcProjectileProfile",
			"IsWideProjectileCastProfile",
			"IsPrecisionProjectileHeadAimProfile",
			"ShouldPreferProjectileBodyAimForProfile",
			"ShouldPreferProjectileFeetImpactForProfile",
			"IsEffectiveHeadshotPriorityEnabled",
			"IsEffectiveAutoFireEnabled",
			"IsEffectiveVisibleCheckEnabled",
			"IsEffectiveTargetSegmentationEnabled",
			"IsEffectiveHookMethodEnabled",
			"IsEffectiveCameraMethodEnabled",
			"IsLegitModeBehaviorActive",
			"IsStickyAimActive",
			"ResetNormalHookHitChanceDecision",
			"ShouldApplyNormalHookHitChance",
			"ShouldIgnoreFovChecks",
			"ShouldIgnoreOffscreenChecks",
			"GetTargetSortDistance",
			"GetCharacterHumanoid",
			"IsHumanoidCharacterModel",
			"GetCharactersFolder",
			"GetCharacterRootPart",
			"GetCharacterHeadPart",
			"GetCharacterTorsoLikePart",
			"SafeGetBasePartAssemblyLinearVelocity",
			"GetCharacterVelocitySamplePart",
			"EstimateCharacterObservedVelocityVector3",
			"GetCharacterVelocityVector3",
			"GetCharacterIdentityString",
			"GetCharacterModelDebugName",
			"RefreshCustomCharacterCaches",
			"EnsureCustomCharacterCaches",
			"GetDirectCharacterModelsFromCharactersFolder",
			"GetCharacterModelsFromCharactersFolder",
			"FindCustomCharacterForPlayer",
			"ResolveCharacterModelForPlayer",
			"InvalidateSearchableCharacterEntriesCache",
			"IsLocalCharacterReadyForAimbot",
			"HasEquippedTool",
		},
		source = [[MenuGui = Instance.new("ScreenGui")
...
HasEquippedGun = function(CharacterModel)
	...
	{
		path = "src/games/bloodzone/10_ballistics.lua",
		exports = {
			"GetBloodZoneMetalShieldTool",
			"GetLocalGunTipWorldPosition",
			"GetCurrentGunVisibilityOrigin",
			"ResolveTrackedTargetPointVector3",
			"GetCurrentTrackedTargetPointVector3",
			"GetCurrentEffectiveAimPointVector3",
			"ResolveWeaponAimOriginVector3",
			"ResolveProjectilePreferredImpactPart",
			"ResolveProjectileBaseTargetPointVector3",
			"EvaluateProjectileTravelTime",
			"SolveLinearInterceptTravelTime",
			"GetForceCurveProjectileTravelTimeNumber",
			"SolveForceCurveProjectileAimPointVector3",
			"ResolveProjectileLaunchVelocityVector3",
			"GetProjectileSplashAcceptanceRadiusNumber",
			"IsProjectileSplashImpactAcceptable",
			"SolveStationaryBallisticTravelTime",
			"SolveProjectileAimPointVector3",
			"SimulateProjectileImpactResult",
			"ResolveProjectileAimSolutionTable",
			"ResolveTargetAimPointVector3",
			"ResolveCurrentSkyTargetData",
			"CachedSkyAimCandidateGroupsByKeyTable",
			"GetSkyAimCandidateGroups",
			"GetFallbackFlatAimDirectionVector3",
			"BuildFallbackSkyAimSolution",
			"BuildSkyAimCandidateFacingDirection",
			"BuildSkyAimCandidateDirection",
			"ResolveSkyAimCandidatePose",
			"GetPointToRayDistance",
			"InternalAimbotRaycastBypassDepth",
			"GetSkyAimAlignmentTolerance",
			"ResolveSkyAimSolution",
		},
		source = [[local function GetBloodZoneMetalShieldTool(CharacterModel)
...
local function ResolveSkyAimSolution(LocalCharacterModel, ReferenceDirectionVector3, EquippedTool, TargetPositionVector3, TargetCharacterModel, TargetPartInstance, SkipCacheBoolean, RequiredPriorityNumber)
	...
	{
		path = "src/games/bloodzone/20_shield_mode.lua",
		exports = {
			"GetFlatFacingDirectionVector3",
			"AreCloseVector3Values",
			"ResolveShotSkyAimDataTable",
			"AppendUniqueIgnoredInstance",
			"IsTypingInTextBox",
			"FindPlayerForCharacterModel",
			"IsLocalControlledCharacterModel",
			"IsPartUnderIgnoredAncestor",
			"GetTargetableParts",
		},
		source = [[function ShieldModeRuntimeTable.ResetState()
...
GetSearchableCharacterEntries = function(LocalCharacterModel, TeamCheckEnabledBoolean, LocalTeamObject)
	...
	{
		path = "src/shared/20_ui.lua",
		exports = {
			"CreateSectionHeader",
			"SmoothingValueLabel",
			"SmoothSliderBackFrame",
			"SmoothSliderFillFrame",
			"SmoothSliderKnobFrame",
			"FovValueLabel",
			"FovSliderBackFrame",
			"FovSliderFillFrame",
			"FovSliderKnobFrame",
			"HeadshotToggleButton",
			"AutoFireToggleButton",
			"VisibleCheckToggleButton",
			"TargetSegmentationToggleButton",
			"FovToggleButton",
			"TargetLineToggleButton",
			"LockKeyToggleButton",
			"HookMethodToggleButton",
			"StickyAimToggleButton",
			"HookHitChanceValueLabel",
			"HookHitChanceSliderBackFrame",
			"HookHitChanceSliderFillFrame",
			"HookHitChanceSliderKnobFrame",
			"SillyModeToggleButton",
			"ShieldModeToggleButton",
			"SillySkyVisibilityToggleButton",
			...
			"ToggleSillyMode",
			"SetTargetCubeVisible",
			"MakeFrameDraggable",
			"SetSmoothingFromRatio",
			"SetFovFromRatio",
			"SetNormalHookHitChanceFromRatio",
		...
		source = [[local function CreateSectionHeader(SectionTitleString, YOffsetNumber)
...
local function UpdateTargetCube(CubeCFrame, CubeSize, SurfacePointVector3)
	...
	{
		path = "src/shared/30_visibility_targeting.lua",
		exports = {
			"IsGlassVisibilityPart",
			"CloneRaycastParamsWithIgnoredInstances",
			"GetVisibilityRaycastBaseParams",
			"CreateVisibilityRaycastParams",
			"DoesSegmentIntersectPartBounds",
			"IsTargetPointBlockedByMetalShield",
			"RaycastToTargetIgnoringGlass",
			"IsVisible",
			"IsCharacterAlive",
			"GetProjectileArcVisibleTargetData",
			"GetVisiblePointForPart",
		},
		source = [[local function IsGlassVisibilityPart(PartInstance)
...
function ShieldModeRuntimeTable.ShouldSkipBloodZoneProjectileRaycastRedirect(LocalCharacterModel, RaycastParamsObject)
	...
	{
		path = "src/shared/40_runtime.lua",
		exports = {
			"ClearMutableTable",
		},
		source = [[local function ClearMutableTable(TableObject)
...
local function CompileSourceString(SourceString, ChunkNameString)
	if LoadStringFunction == load and type(load) == "function" then
		return LoadStringFunction(SourceString, ChunkNameString, "t", SharedEnvironmentTable)
	end

	local ChunkFunction, CompileErrorString = LoadStringFunction(SourceString, ChunkNameString)
	if type(ChunkFunction) == "function" and type(setfenv) == "function" then
		pcall(setfenv, ChunkFunction, SharedEnvironmentTable)
	end

	return ChunkFunction, CompileErrorString
end

local function CompileAndRunSegment(SegmentTable)
	local WrappedSourceString = SegmentTable.source
	if #SegmentTable.exports > 0 then
		local ExportLinesTable = {}
		for IndexNumber, ExportNameString in ipairs(SegmentTable.exports) do
			ExportLinesTable[IndexNumber] = ("__TRUE_AIM_EXPORT_ENV[%q] = %s"):format(ExportNameString, ExportNameString)
		end
		WrappedSourceString = WrappedSourceString .. "\n" .. table.concat(ExportLinesTable, "\n")
	end

	local ChunkFunction, CompileErrorString = CompileSourceString(WrappedSourceString, "@" .. SegmentTable.path)
	if type(ChunkFunction) ~= "function" then
		error(("true-aim: failed to compile segment %s (%s)"):format(SegmentTable.path, tostring(CompileErrorString)), 0)
	end

	local SuccessBoolean, ResultValue = pcall(ChunkFunction)
	if not SuccessBoolean then
		error(ResultValue, 0)
	end
...
for _, SegmentTable in ipairs(BundleSegmentsTable) do
	CompileAndRunSegment(SegmentTable)
end

SharedEnvironmentTable.__TRUE_AIM_EXPORT_ENV = nil
