...
-- assembled segments: 10
-- shared top-level locals: 95

-- cross-segment locals hoisted by the assembler
local RunService, Players, WorkspaceService, CollectionService, ReplicatedStorageService, UserInputService, GuiService, TweenService, VirtualInputManager, LocalPlayer, Camera, MouseObject, PlayerListRuntimeTable, ShieldModeRuntimeTable, GetSearchableCharacterEntries, RaycastBetweenIgnoringGlass, IsCharacterForceFieldProtected, GetPreferredTargetPart, HasEquippedGun, IsRaycastResultTargetHit
local RunUnredirectedWorkspaceRaycast, ExplosiveProjectileNameSetTable, LauncherBallisticsProfileByNameTable, IsSupportedBloodZoneWeaponType, SafeDebugName, GetTargetIdentity, UpdateDebugStatus, IsMouseOverAimbotUi, UiInteractionRuntimeTable, IsAimbotUiInputSuppressed, SendAimbotMouseClick, DebugLog, TraceLog, FormatDebugVector3, DescribeDebugInstance, SafeGetLocalGunBase, ResetRejectCounts, RecordRejectReason, GetRejectCountsSummary, IsSillyModeEnabled
local IsSillyModeBehaviorActive, IsEffectiveShieldModeEnabled, ShouldUseForceCurveProjectileProfile, GetProjectileProfileGravityNumber, GetProjectileProfileGravityMagnitudeNumber, GetProjectileSplashRadiusNumber, ShouldUseProjectileArcVisibilityProfile, ShouldPreferHighArcProjectileProfile, ShouldPreferProjectileBodyAimForProfile, ShouldPreferProjectileFeetImpactForProfile, IsEffectiveHeadshotPriorityEnabled, IsEffectiveAutoFireEnabled, IsEffectiveVisibleCheckEnabled, IsEffectiveTargetSegmentationEnabled, IsEffectiveHookMethodEnabled, IsEffectiveCameraMethodEnabled, IsStickyAimActive, ResetNormalHookHitChanceDecision, ShouldApplyNormalHookHitChance, ShouldIgnoreFovChecks
local ShouldIgnoreOffscreenChecks, GetTargetSortDistance, GetCharacterHumanoid, IsHumanoidCharacterModel, GetCharacterRootPart, GetCharacterHeadPart, GetCharacterTorsoLikePart, GetCharacterVelocityVector3, GetCharacterModelDebugName, GetCharacterModelsFromCharactersFolder, FindCustomCharacterForPlayer, ResolveCharacterModelForPlayer, IsLocalCharacterReadyForAimbot, HasEquippedTool, GetBloodZoneMetalShieldTool, GetLocalGunTipWorldPosition, GetCurrentGunVisibilityOrigin, GetCurrentTrackedTargetPointVector3, GetCurrentEffectiveAimPointVector3, ResolveWeaponAimOriginVector3
local ResolveProjectileBaseTargetPointVector3, ResolveProjectileAimSolutionTable, ResolveTargetAimPointVector3, InternalAimbotRaycastBypassDepth, ResolveSkyAimSolution, AppendUniqueIgnoredInstance, IsTypingInTextBox, GetTargetableParts, GetCurrentLockKeyMode, RefreshBloodZoneBehaviorButtons, SetTargetCubeVisible, IsPointInCircle, GetCubeSize, UpdateTargetCube, IsCharacterAlive

-- begin segment: src/shared/00_bootstrap.lua
do
RunService = game.GetService(game, "RunService")
Players = game.GetService(game, "Players")
WorkspaceService = game.GetService(game, "Workspace")
CollectionService = game.GetService(game, "CollectionService")
ReplicatedStorageService = game.GetService(game, "ReplicatedStorage")
UserInputService = game.GetService(game, "UserInputService")
GuiService = game.GetService(game, "GuiService")
TweenService = game.GetService(game, "TweenService")
VirtualInputManager = game.GetService(game, "VirtualInputManager")

LocalPlayer = Players.LocalPlayer
Camera = WorkspaceService.CurrentCamera
MouseObject = LocalPlayer.GetMouse(LocalPlayer)
...
-- end segment: src/shared/00_bootstrap.lua

-- begin segment: src/games/00_registry.lua
do
...
-- end segment: src/games/00_registry.lua

-- begin segment: src/shared/05_runtime_state.lua
do
...
GetSearchableCharacterEntries = GetSearchableCharacterEntries
RaycastBetweenIgnoringGlass = RaycastBetweenIgnoringGlass
IsCharacterForceFieldProtected = IsCharacterForceFieldProtected
GetPreferredTargetPart = GetPreferredTargetPart
HasEquippedGun = HasEquippedGun
IsRaycastResultTargetHit = IsRaycastResultTargetHit
RunUnredirectedWorkspaceRaycast = RunUnredirectedWorkspaceRaycast

end
-- end segment: src/shared/05_runtime_state.lua

-- begin segment: src/games/bloodzone/00_settings.lua
do
...
-- end segment: src/games/bloodzone/00_settings.lua

-- begin segment: src/shared/10_core.lua
do
...
-- begin segment: src/games/bloodzone/10_ballistics.lua
do
...
InternalAimbotRaycastBypassDepth = 0
...
-- end segment: src/games/bloodzone/10_ballistics.lua

-- begin segment: src/games/bloodzone/20_shield_mode.lua
do
...
-- end segment: src/games/bloodzone/20_shield_mode.lua

-- begin segment: src/shared/20_ui.lua
do
...
SetTargetCubeVisible = SetTargetCubeVisible
...
-- end segment: src/shared/20_ui.lua

-- begin segment: src/shared/30_visibility_targeting.lua
do
...
-- end segment: src/shared/30_visibility_targeting.lua

-- begin segment: src/shared/40_runtime.lua
do
...
-- end segment: src/shared/40_runtime.lua
